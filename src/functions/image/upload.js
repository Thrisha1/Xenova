...
import { s3PostUrl } from './s3'
// import { toast } from 'react-toastify'


async function getpresignedUrl(imageList, folder) {
    ...
    imageList.forEach((file) => {
        ...
        presignedUrlPromise.push(s3PostUrl(file, folder));
    });
...
export const handleImage = async (fileL, folder = "") => {
    let uploadArray = [];
